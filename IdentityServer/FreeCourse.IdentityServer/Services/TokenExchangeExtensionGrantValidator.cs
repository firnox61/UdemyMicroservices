...
namespace FreeCourse.IdentityServer.Services
{
    public class TokenExchangeExtensionGrantValidator : IExtensionGrantValidator
    {
        ...
        private readonly ITokenValidator _tokenValidator;//gelen tokeni doğrulama yapıcaz
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
           var requestRaw=context.Request.Raw.ToString();
            ...
            //subdan gelen ıd usırn ıd si access token olduğğunu belirtiyoruz ve token içieirisindeki bulıunacak claimleri veriyotuöm
